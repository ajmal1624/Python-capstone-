...
* Most launch sites are near the equator, and as well as close to the coast

### Predictive Analytics
* All models performed similarly on the test set. The decision tree model slightly better when looking at .best_score_
